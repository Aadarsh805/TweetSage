      ...
      >
        ...
        <div className="mt-60 h-screen w-full flex flex-col items-center justify-center relative z-30">
          ...
          <div
            role="button"
            onClick={() => {
              transitionRef!.current!.style.transform = `translateY(0vh)`;
            }}
            className="absolute bottom-0 right-20 w-12 h-12 rounded-full shadow-xl transition duration-300 hover:bg-[#7214fff1] bg-[#7214ffb6] flex items-center justify-center"
          >
