...
const Navbar = () => {
  return (
    <nav className="fixed z-50 top-0  w-full flex items-center justify-between text-white px-5  md:px-20 py-6">
      <div className="flex items-center justify-center gap-5">
        <Image className="w-[8em] md:w-[12em]" src={Logo} alt="logo" />
      </div>
      <Link href="https://github.com/Aadarsh805/TweetSage.ai">
        <div className="gap-2 inline-flex items-center justify-center h-10 px-2 py-3 text-xs bg-transparent text-white border-2 border-[#090426] rounded-md">
          <GitHubIcon className=" text-2xl lg:text-3xl text-[#090426] w-7 h-7" />
